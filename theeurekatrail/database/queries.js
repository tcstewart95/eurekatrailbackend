...
const createAccount = function (fb_id, g_id, username, firstname, lastname, password, hp, company_id, inventory_id, role_id, image, authenticated, callback) {
  console.log("INSERT INTO player (fb_id, g_id, username, firstname, lastname, password, hp, company_id, inventory_id, role_id, image, authenticated) VALUES ('"+fb_id+"', '"+g_id+"', '"+username+"','"+password+"', "+hp+", "+company_id+", "+inventory_id+", "+role_id+", '"+image+"');");
