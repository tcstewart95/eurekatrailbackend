...
const createAccount = function (username, firstname, lastname, password, hp, company_id, inventory_id, role_id, image, authenticated, callback) {
  console.log("INSERT INTO player (username, firstname, lastname, password, hp, company_id, inventory_id, role_id, image, authenticated) VALUES ('"+username+"','"+password+"', "+hp+", "+company_id+", "+inventory_id+", "+role_id+", '"+image+"');");
  client.query("INSERT INTO player (username, firstname, lastname, password, hp, company_id, inventory_id, role_id, image, authenticated) VALUES ('"+username+"','"+firstname+"', '"+lastname+"', '"+password+"', "+hp+", "+company_id+", "+inventory_id+", "+role_id+", '"+image+"', '"+authenticated+"');"), function (err, result, fields) {
